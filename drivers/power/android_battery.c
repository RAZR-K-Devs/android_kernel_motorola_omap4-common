...
extern unsigned int set_battery_max_level(unsigned int cpu_mhz_lvl);
...
*/
void set_batt_mhz_info(unsigned int batt_lvl_low, unsigned int batt_lvl_high, unsigned int cpu_mhz_lvl_low, unsigned int cpu_mhz_lvl_high)
{
...
void get_batt_level(unsigned int* cpu_mhz_lvl)
{
	//CPU
...
//	unsigned int gpu_mhz_lvl = 0;
	...
	if (cpu_mhz_lvl > 0)
		Lscreen_off_scaling_mhz_orig = set_battery_max_level(cpu_mhz_lvl);
