...
export LOCALVERSION="-JBX-3.2-Hybrid-Atrix2-4.4"
...
zip -r "JBX-Kernel-3.2-Hybrid-Edison-4.4_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-3.2-Hybrid-Edison-4.4_$(date +"%Y-%m-%d").zip" /home/dtrail/android/out
