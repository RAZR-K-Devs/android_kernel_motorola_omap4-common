...
export LOCALVERSION="-JBX-3.3-Hybrid-Razr-4.4"
# Choose build option
cd /data/4.4
while true; do
...
zip -r "JBX-Kernel-3.3-Hybrid-Spyder-4.4_$(date +"%Y-%m-%d").zip" *
mv "JBX-Kernel-3.3-Hybrid-Spyder-4.4_$(date +"%Y-%m-%d").zip" /home/dtrail/android/out
